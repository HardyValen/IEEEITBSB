...
class CreateCasestudy2019participantsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('casestudy2019participants', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('casestudy2019participants');
    }
}
