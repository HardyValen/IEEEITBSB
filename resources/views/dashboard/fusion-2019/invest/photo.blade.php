...
@section('content')
&larr; <a href='/dashboard'>Dashboard</a>&ensp;/&ensp;<a href='/dashboard/invest'>Innovation Contest</a>&ensp;/&ensp;<a href='/dashboard/invest/manage-team'>Manage Team</a>
...
<div class="guidebook-container">
    ...
    <form action="/upload-process-invest" method="POST" enctype = "multipart/form-data">
        @csrf 
