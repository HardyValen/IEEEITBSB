...
@section('sidebar')
    @include('dashboard/subsection/sidebar/sidebar-guidebook')
@endsection
...
@section('content')
    ...
    <h1>Guidebook Health Disaster Hack</h1>

    <div class="row" >
            <div class="offset-lg-1 col-lg-10 my-4" id='essay-tac'>
        ...
        <div class="row" >
            <div class="offset-lg-1 col-lg-10 my-4" id='hackathon-tac'>
        ...
        <div class="row" >
            <div class="offset-lg-1 col-lg-10 my-4" id='essay-criteria'>
        ...
        <div class="row" >
            <div class="offset-lg-1 col-lg-10 my-4" id='scoring'>
                <h2>Scoring</h2>
                <ol>
                    <li>
                        Feasibility
        ...
        <div class="row" >
            <div class="offset-lg-1 col-lg-10 my-4" id='registration'>
